                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: const [
                        ...
                        SizedBox(height: 20),
                        Text(
                          'A banner display an important succinct message, and provides actions for users to address (or dismiss the banner). \nA user action is required for it to bi simissed.',
